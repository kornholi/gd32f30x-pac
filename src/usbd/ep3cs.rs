#[doc = "Reader of register EP3CS"]
pub type R = crate::R<u32, super::EP3CS>;
#[doc = "Writer for register EP3CS"]
pub type W = crate::W<u32, super::EP3CS>;
#[doc = "Register EP3CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP3CS {
    type Type = u32;
    #[inline(always)]
