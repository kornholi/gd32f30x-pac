...
#[doc = "GPIO port configuration lock register"]
pub mod lock;
#[doc = "Port bit speed register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spd](spd) module"]
pub type SPD = crate::Reg<u32, _SPD>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SPD;
#[doc = "`read()` method returns [spd::R](spd::R) reader structure"]
impl crate::Readable for SPD {}
#[doc = "`write(|w| ..)` method takes [spd::W](spd::W) writer structure"]
impl crate::Writable for SPD {}
#[doc = "Port bit speed register"]
pub mod spd;
