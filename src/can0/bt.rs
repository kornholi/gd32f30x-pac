...
#[doc = "Reader of field `BUADPSC`"]
pub type BUADPSC_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `BUADPSC`"]
pub struct BUADPSC_W<'a> {
    w: &'a mut W,
}
impl<'a> BUADPSC_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    #[inline(always)]
    pub fn buadpsc(&self) -> BUADPSC_R {
        BUADPSC_R::new((self.bits & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bit 31 - Silent communication mode"]
    ...
    #[doc = "Bits 0:9 - Baud rate prescaler"]
    #[inline(always)]
    pub fn buadpsc(&mut self) -> BUADPSC_W {
        BUADPSC_W { w: self }
    }
}
