...
#[doc = "Reader of field `TIMER11EN`"]
pub type TIMER11EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER11EN`"]
pub struct TIMER11EN_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER11EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `TIMER12EN`"]
pub type TIMER12EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER12EN`"]
pub struct TIMER12EN_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER12EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `USBDEN`"]
pub type USBDEN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `USBDEN`"]
...
impl R {
    ...
    pub fn usbden(&self) -> USBDEN_R {
        USBDEN_R::new(((self.bits >> 23) & 0x01) != 0)
    }
