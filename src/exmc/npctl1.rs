#[doc = "Reader of register NPCTL1"]
pub type R = crate::R<u32, super::NPCTL1>;
#[doc = "Writer for register NPCTL1"]
pub type W = crate::W<u32, super::NPCTL1>;
#[doc = "Register NPCTL1 `reset()`'s with value 0x18"]
impl crate::ResetValue for super::NPCTL1 {
    type Type = u32;
    #[inline(always)]
