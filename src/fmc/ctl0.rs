...
#[doc = "Reader of field `OBWPE`"]
pub type OBWPE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OBWPE`"]
pub struct OBWPE_W<'a> {
    w: &'a mut W,
}
impl<'a> OBWPE_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[inline(always)]
    pub fn obwpe(&self) -> OBWPE_R {
        OBWPE_R::new(((self.bits >> 9) & 0x01) != 0)
    }
