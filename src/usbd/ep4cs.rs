#[doc = "Reader of register EP4CS"]
pub type R = crate::R<u32, super::EP4CS>;
#[doc = "Writer for register EP4CS"]
pub type W = crate::W<u32, super::EP4CS>;
#[doc = "Register EP4CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP4CS {
    type Type = u32;
    #[inline(always)]
