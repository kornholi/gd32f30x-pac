#[doc = "Reader of register EP6CS"]
pub type R = crate::R<u32, super::EP6CS>;
#[doc = "Writer for register EP6CS"]
pub type W = crate::W<u32, super::EP6CS>;
#[doc = "Register EP6CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP6CS {
    type Type = u32;
    #[inline(always)]
