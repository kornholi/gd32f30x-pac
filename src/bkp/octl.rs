...
pub type CALDIR_R = crate::R<bool, bool>;
...
#[doc = "Reader of field `CCOSEL`"]
pub type CCOSEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CCOSEL`"]
pub struct CCOSEL_W<'a> {
    w: &'a mut W,
}
impl<'a> CCOSEL_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn caldir(&self) -> CALDIR_R {
        CALDIR_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 14 - RTC clock output selection"]
    #[inline(always)]
    pub fn ccosel(&self) -> CCOSEL_R {
        CCOSEL_R::new(((self.bits >> 14) & 0x01) != 0)
    }
