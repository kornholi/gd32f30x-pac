#[doc = "Reader of register EP0CS"]
pub type R = crate::R<u32, super::EP0CS>;
#[doc = "Writer for register EP0CS"]
pub type W = crate::W<u32, super::EP0CS>;
#[doc = "Register EP0CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP0CS {
    type Type = u32;
    #[inline(always)]
