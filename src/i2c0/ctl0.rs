...
#[doc = "Reader of field `DISSTRC`"]
pub type DISSTRC_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DISSTRC`"]
pub struct DISSTRC_W<'a> {
    w: &'a mut W,
}
impl<'a> DISSTRC_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[inline(always)]
    pub fn disstrc(&self) -> DISSTRC_R {
        DISSTRC_R::new(((self.bits >> 7) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - Whether to stretch SCL low when data is not ready in slave mode"]
    #[inline(always)]
    pub fn disstrc(&mut self) -> DISSTRC_W {
        DISSTRC_W { w: self }
    }
    #[doc = "Bit 6 - Whether or not to response to a General Call (0x00)"]
    #[inline(always)]
