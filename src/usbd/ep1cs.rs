#[doc = "Reader of register EP1CS"]
pub type R = crate::R<u32, super::EP1CS>;
#[doc = "Writer for register EP1CS"]
pub type W = crate::W<u32, super::EP1CS>;
#[doc = "Register EP1CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP1CS {
    type Type = u32;
    #[inline(always)]
