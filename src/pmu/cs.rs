...
#[doc = "Reader of field `LDRF`"]
pub type LDRF_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `LDRF`"]
pub struct LDRF_W<'a> {
    w: &'a mut W,
}
impl<'a> LDRF_W<'a> {
...
#[doc = "Reader of field `HDSRF`"]
pub type HDSRF_R = crate::R<bool, bool>;
#[doc = "Reader of field `HDRF`"]
pub type HDRF_R = crate::R<bool, bool>;
#[doc = "Reader of field `LDOVSRF`"]
pub type LDOVSRF_R = crate::R<bool, bool>;
