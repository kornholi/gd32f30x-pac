#[doc = "Reader of register EP5CS"]
pub type R = crate::R<u32, super::EP5CS>;
#[doc = "Writer for register EP5CS"]
pub type W = crate::W<u32, super::EP5CS>;
#[doc = "Register EP5CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP5CS {
    type Type = u32;
    #[inline(always)]
