...
#[doc = "Reader of field `TIMER11RST`"]
pub type TIMER11RST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER11RST`"]
pub struct TIMER11RST_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER11RST_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `TIMER12RST`"]
pub type TIMER12RST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER12RST`"]
pub struct TIMER12RST_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER12RST_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub type USBDRST_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn timer11rst(&self) -> TIMER11RST_R {
        TIMER11RST_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 7 - TIMER12 timer reset"]
    #[inline(always)]
    pub fn timer12rst(&self) -> TIMER12RST_R {
        TIMER12RST_R::new(((self.bits >> 7) & 0x01) != 0)
    }
