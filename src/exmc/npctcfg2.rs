#[doc = "Reader of register NPCTCFG2"]
pub type R = crate::R<u32, super::NPCTCFG2>;
#[doc = "Writer for register NPCTCFG2"]
pub type W = crate::W<u32, super::NPCTCFG2>;
#[doc = "Register NPCTCFG2 `reset()`'s with value 0xfcfc_fcfc"]
impl crate::ResetValue for super::NPCTCFG2 {
    type Type = u32;
    #[inline(always)]
