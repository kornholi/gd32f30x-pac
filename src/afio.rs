...
#[doc = "AFIO port configuration register 1"]
pub mod pcf1;
#[doc = "IO compensation control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpsctl](cpsctl) module"]
pub type CPSCTL = crate::Reg<u32, _CPSCTL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CPSCTL;
#[doc = "`read()` method returns [cpsctl::R](cpsctl::R) reader structure"]
impl crate::Readable for CPSCTL {}
#[doc = "`write(|w| ..)` method takes [cpsctl::W](cpsctl::W) writer structure"]
impl crate::Writable for CPSCTL {}
#[doc = "IO compensation control register"]
pub mod cpsctl;
