#[doc = "Reader of register EP2CS"]
pub type R = crate::R<u32, super::EP2CS>;
#[doc = "Writer for register EP2CS"]
pub type W = crate::W<u32, super::EP2CS>;
#[doc = "Register EP2CS `reset()`'s with value 0"]
impl crate::ResetValue for super::EP2CS {
    type Type = u32;
    #[inline(always)]
