...
#[doc = "Deep sleep mode Voltage register"]
pub mod dsv;
#[doc = "Additional clock control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [addctl](addctl) module"]
pub type ADDCTL = crate::Reg<u32, _ADDCTL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADDCTL;
#[doc = "`read()` method returns [addctl::R](addctl::R) reader structure"]
impl crate::Readable for ADDCTL {}
#[doc = "`write(|w| ..)` method takes [addctl::W](addctl::W) writer structure"]
impl crate::Writable for ADDCTL {}
#[doc = "Additional clock control register"]
pub mod addctl;
#[doc = "Additional clock interrupt register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [addint](addint) module"]
pub type ADDINT = crate::Reg<u32, _ADDINT>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADDINT;
#[doc = "`read()` method returns [addint::R](addint::R) reader structure"]
impl crate::Readable for ADDINT {}
#[doc = "`write(|w| ..)` method takes [addint::W](addint::W) writer structure"]
impl crate::Writable for ADDINT {}
#[doc = "Additional clock interrupt register"]
pub mod addint;
#[doc = "APB1 additional reset register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [addapb1rst](addapb1rst) module"]
pub type ADDAPB1RST = crate::Reg<u32, _ADDAPB1RST>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADDAPB1RST;
#[doc = "`read()` method returns [addapb1rst::R](addapb1rst::R) reader structure"]
impl crate::Readable for ADDAPB1RST {}
#[doc = "`write(|w| ..)` method takes [addapb1rst::W](addapb1rst::W) writer structure"]
impl crate::Writable for ADDAPB1RST {}
#[doc = "APB1 additional reset register"]
pub mod addapb1rst;
#[doc = "APB1 additional enable register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [addapb1en](addapb1en) module"]
pub type ADDAPB1EN = crate::Reg<u32, _ADDAPB1EN>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ADDAPB1EN;
#[doc = "`read()` method returns [addapb1en::R](addapb1en::R) reader structure"]
impl crate::Readable for ADDAPB1EN {}
#[doc = "`write(|w| ..)` method takes [addapb1en::W](addapb1en::W) writer structure"]
impl crate::Writable for ADDAPB1EN {}
#[doc = "APB1 additional enable register"]
pub mod addapb1en;
